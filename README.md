<p align="center">
  <img src="./cicada.png" width="220" alt="FLETCH cicada · Robin Hood 4663">
</p>

<h1 align="center">FLETCH</h1>

<p align="center">
  <strong>Robin Hood Chain 4663</strong><br>
  the valuable is not listed. it is hunted.
</p>

<p align="center">
  Live hatch tape for <a href="https://robinhood.com/chain">Robin Hood Chain</a> <code>4663</code>.<br>
...
<p align="center">
  <img alt="Robin Hood" src="https://img.shields.io/badge/Robin%20Hood-Chain%204663-5eead4?style=flat-square&labelColor=11140f">
...
<p align="center"><code>ROBIN HOOD 4663 · HELLO. WE ARE LOOKING FOR HIGHLY INTELLIGENT INDIVIDUALS.</code></p>
...
Cicada 3301 hid the prize in the search. FLETCH does the same on **Robin Hood Chain 4663**.
...
| swap | Uniswap V4 on Robin Hood 4663 (Pons hooks included). You confirm in Rabby / MetaMask |
...
Connect a wallet, add **Robin Hood 4663**, pick a hatch, quote the pool, sign the swap. The site never holds a key.
...
Not financial advice. FLETCH never holds keys. Every live trade on Robin Hood 4663 is `eth_sendTransaction` you confirm in the wallet.
